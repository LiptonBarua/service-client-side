      ...
      <div className='grid justify-items-center my-10'>
        ...
        <form onSubmit={handleSubmit} novalidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
            <div className="space-y-1 text-sm">
                ...
                <input type="text" name="name" id="" placeholder="Your Name" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
            </div>
            <div className="space-y-1 text-sm">
            ...
            <button className="block w-full bg-info p-3 text-center rounded-sm dark:text-gray-900 dark:bg-violet-400">Register</button>
        </form>
        ...
        <Link to='/login' className="underline dark:text-gray-100 ml-2 text-orange-600 font-bold">Sign In</Link>
        </p>
    </div>
      </div>
    );
